...
@vite(['resources/css/pages/Formdangkydetai.css', 'resources/js/pages/Formdangkydetai.js'])
@section('content')
                ...
                <div class="card-body">
                    <form id="dangKyDeTaiForm">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <label for="tendetai">Tên đề tài <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="loaidetai">Loại đề tài <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="linhvuc">Lĩnh vực nghiên cứu <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="Sogiotacgia">Số giờ tác giả <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="sothang">Số Tháng <span class="text-danger">*</span></label>
        ...
        <div class="card mb-3 thanh-vien-item">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-5">
                        <div class="form-group">
                            <label>Tên thành viên <span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label>Số giờ tham gia <span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="thanhvien[][vaitro]" required>
